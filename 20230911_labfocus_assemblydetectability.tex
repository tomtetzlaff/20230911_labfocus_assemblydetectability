  ...
  \parbox{\linewidth}{
    \onslide<2->{
      \parbox{0.49\linewidth}{%
        $\rho=2100\,\text{mm}^{-3}$:\\[1ex]    \includegraphics[width=\linewidth]{./figures/minimal_model_stats_rho_2100_AB.png}
      }%
    }%
    \hfill%
    \onslide<3->{    
      \parbox{0.49\linewidth}{%
        $\rho=35000\,\text{mm}^{-3}$:\\[1ex] \includegraphics[width=\linewidth]{./figures/minimal_model_stats_rho_35000_AB.png}  
      }
    }
  }
\end{frame}
...
\begin{frame}[plain]
  ...
  \onslide<2->{
    \parbox{\linewidth}{
      {\bf\small minimal assembly model:}\\    \includegraphics[width=\linewidth]{./figures/minimal_model_stats_rho_35000.pdf}\\
...
\begin{frame}[plain]
  ...
  \parbox{\linewidth}{
    ...
    {\small\input{./figures/minimal_model_stats_3d_caption.tex}}
  }
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\def\ttl{Assembly detectability}
...
\begin{frame}[plain]
  ...
  \parbox{\linewidth}{
    ...
    {\small\input{./figures/minimal_model_assembly_detectability_rho_2100_caption.tex}}
  }
\end{frame}
\begin{frame}[plain]
  \frametitle{\ttl}
  \parbox{\linewidth}{
    ...
    {\small\input{./figures/minimal_model_assembly_detectability_rho_35000_caption.tex}}
  }
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document}
